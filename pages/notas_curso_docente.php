...
$nombre_completo="";
$nombre_curso="";
              $query=mysqli_query($con,"select * from usuario where id='$id_estudiante' ")or die(mysqli_error());
    $i=0;
 ...
 <!--end of modal-->
                ...
                <a class="btn btn-danger btn-print" href="<?php  echo "cursos_docente_alumnos.php?id_curso=$id_curso&id_temporada=$id_temporada";?>"  role="button">Retroceder</a>
                 <a class = "btn btn-success btn-print" href = "<?php  echo "cursos_docente_alumnos.php?id_curso=$id_curso&id_temporada=$id_temporada";?>" onclick = "window.print()"><i class ="glyphicon glyphicon-print"></i> Impresión</a>
...
$promedio=0;
    ...
    $query=mysqli_query($con,"select * from examen_alumno  where id_temporada='$id_temporada' and id_usuario='$id_estudiante' and id_curso='$id_curso' ")or die(mysqli_error());
    $i=0;
    while($row=mysqli_fetch_array($query)){
