...
<td><?php echo $row['descripcion_examen'];?></td>
  <td><?php echo $row['nombre_curso'];?></td>      
                      ...
                      ?>
                      <a class="small-box-footer btn-print" href="<?php  echo "eliminar_examen_docente.php?id_examen=$id_examen&id_temporada=$id_temporada&id_curso=$id_curso";?>" onClick="return confirm('¿Está seguro de que desea eliminar??');"" > <i class="glyphicon glyphicon-remove"></i></a>


<a class="btn btn-danger btn-print" href="<?php  echo "pregunta_agregar_docente.php?id_examen=$id_examen&id_temporada=$id_temporada&id_curso=$id_curso";?>"  role="button">Preguntas</a> 
  ...
  <div class="modal-dialog" style="width: 900px; height: 900px;">
    <div class="modal-content" style="height:auto">
        ...
        <form class="form-horizontal" method="post" action="examen_actualizar_docente.php" enctype='multipart/form-data'>
