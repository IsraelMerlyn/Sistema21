...
<a class="btn btn-danger btn-print" href="<?php  echo "lista_examenes_curso.php?id_curso=$id_curso&id_temporada=$id_temporada";?>"  role="button">Retroceder</a>
                        <div class="box-body">
                  <!-- Date range -->
                  <form method="post" action="pregunta_add_docente.php" enctype="multipart/form-data" class="form-horizontal">
              <div class="row">
...
?>
    ...
    <td>
      ...
      <a class="btn btn-danger btn-print" href="<?php  echo "opciones_agregar_docente.php?id_pregunta=$id_pregunta&id_examen=$id_examen&id_temporada=$id_temporada&id_curso=$id_curso";?>"  role="button">Agregar Opciones</a> 
    </td>
                        <td>
<a class="small-box-footer btn-print" href="<?php  echo "eliminar_pregunta_docente.php?id_pregunta=$id_pregunta&id_examen=$id_examen&id_temporada=$id_temporada&id_curso=$id_curso";?>" onClick="return confirm('¿Está seguro de que desea eliminar??');"" > <i class="glyphicon glyphicon-remove"></i></a>
  ...
  <div class="modal-dialog" style="width: 900px; height: 900px;">
    <div class="modal-content" style="height:auto">
        ...
        <form class="form-horizontal" method="post" action="pregunta_actualizar_docente.php" enctype='multipart/form-data'>
