...
$nombre_curso="";
 ...
 <!--end of modal-->
                ...
                <a class="btn btn-danger btn-print" href="<?php  echo "cursos_alumno_constancia.php?id_temporada=$id_temporada";?>"  role="button">Retroceder</a>
                 <a class = "btn btn-success btn-print" href = "<?php  echo "cursos_alumno_constancia.php?id_temporada=$id_temporada";?>" onclick = "window.print()"><i class ="glyphicon glyphicon-print"></i> Impresión</a>
