...
?>
 ...
 <!--end of modal-->
              ...
              <a class="btn btn-warning btn-print" href="propietario.php"    style="height:25%; width:15%; font-size: 12px " role="button">Regresar</a>
...
<?php
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from propietario where id_propietario= '$id_propietario' ")or die(mysqli_error());
    $i=1;
...
?>
        ...
        <form class="form-horizontal" method="post" action="propietario_actualizar.php" enctype='multipart/form-data'>
            <input type="hidden" class="form-control" id="id_propietario" name="id_propietario" value="<?php echo $row['id_propietario'];?>" required>
