...
?>
   ...
   <?php
    ...
    $query=mysqli_query($con,"select * from prestamos AS p INNER JOIN clientes AS c ON c.id_cliente = p.id_cliente   where  fecha BETWEEN '$fecha7days' AND '$fechaActual'  ")or die(mysqli_error());
    $contador=0;
