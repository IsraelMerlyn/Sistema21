...
?>
 ...
 <!--end of modal-->
                  ...
                  <h3 class="box-title"> MODIFICAR DOCENTE</h3>
                </div><!-- /.box-header -->
              
              <a class="btn btn-warning btn-print" href="alumno.php"    style="height:25%; width:15%; font-size: 12px " role="button">Regresar</a>
...
?>
        ...
        <form class="form-horizontal" method="post" action="alumno_actualizar.php" enctype='multipart/form-data'>
        ...
        <input type="text" class="form-control" id="apellido" name="apellido" value="<?php echo $row['apellido'];?>"   required>
            ...
            <input type="text" class="form-control" id="telefono"  name="telefono"  value="<?php echo $row['telefono'];?>" >
                ...
                <select class="form-control select2" style="width: 60%;" name="tipo" id="tipo"> <br>
                     ...
                     <option value="docente" <?php if($tipo=="estudiante") {echo "selected"; }?>>docente</option> 
